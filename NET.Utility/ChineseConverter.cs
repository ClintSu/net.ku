        ...
        public static Hashtable PinYinSpecialList
        {
            get
            {
                if (ChineseConverter.m_PinYinSpecialList == null)
                {
                    ...
                    ChineseConverter.m_PinYinSpecialList.Add((object)"重庆", (object)"Chong Qing");
                    ChineseConverter.m_PinYinSpecialList.Add((object)"深圳", (object)"Shen Zhen");
                    ChineseConverter.m_PinYinSpecialList.Add((object)"什么", (object)"Shen Me");
                }
