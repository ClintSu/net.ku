    ...
    public sealed class Hook
    {
        ...
        public void InstallMouseHook(HookType type)
        {
            if (mshHook == 0)
            {
                ...
                // POWERPNT.EXE
                string moduleName = "POWERPNT.EXE";
        ...
        {
            System.Windows.Forms.MouseEventArgs e = new System.Windows.Forms.MouseEventArgs(button, clickCount, p.x, p.y, 0);
            if (eventName != null)
