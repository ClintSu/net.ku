...
namespace NET.Utilities
{
    public class IOHelper
    {
        ...
        public static void GetLocalFiles(List<IOFileInfo> list, string root, string ext = "*.*", string path = null)
        {
            // 读取目录下文件信息
        ...
        public static bool UpdateFile(IOFileInfo file, string root, byte[] bytes)
        {
            var rename = false;
